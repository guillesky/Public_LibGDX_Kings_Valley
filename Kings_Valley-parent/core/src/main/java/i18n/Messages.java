...
public enum Messages
{
    ...
    /**
     * Mensaje correspondiente a "Gran Templo Actual"
     */
    CURRENT_GREAT_TEMPLE("Gran Templo Actual: "),
    ...
    CREDITS("Credits"),
    /**
     * Mensaje correspondiente a "Instrucciones"
     */
     ...
     */
    GOING_BACK_PYRAMID("Back to Pyramid "),
    /**
     * Mensaje correspondiente a "Volviendo al Gran Templo"
     */
    GOING_BACK_GREAT_TEMPLE("Back to Great Temple "),
    /**
     * Mensaje correspondiente a "Entrando a la Piramide "
     */

    ENTERING_PYRAMID("Entering Pyramid "),

    /**
     * Mensaje correspondiente a "Entrando al Gran Templo "
     */
    ENTERING_GREAT_TEMPLE("Entering to Great Temple "),
    /**
    ...
    /**
     * Mensaje correspondiente a "Felicitaciones! Has completado un episodio.Podras
     * comenzar desde aqui la proxima vez."
     */
    FINISH_EPISODE("Congratulations! You have completed an episode.\nYou can start from here next time."),
    /**
     * Mensaje correspondiente a "Has conquistado todos los niveles! El tesoro es
     * tuyo."
     */
    ENTER_GOAL_LEVEL("You have conquered all levels!\nThe treasure is yours."),
    /**
     * Mensaje correspondiente a "Has dominado todos los niveles. Te atreves con una
     * dificultad mayor?"
     */
    FINISH_GAME("You have mastered all levels.\nDare to face a higher difficulty?"),

    /**
     * Mensaje correspondiente a "Templo"
     */
    TEMPLE("Temple "),
    /**
     * Mensaje correspondiente a "Modo de Pantalla"
     */
    DISPLAY_MODE("Display Mode"),
    /**
     * Mensaje correspondiente a "Pantalla Completa"
     */
    FULL_SCREEN("Full Screen"),
    /**
     * Mensaje correspondiente a "En Ventana"
     */
    WINDOWED("Windowed");
