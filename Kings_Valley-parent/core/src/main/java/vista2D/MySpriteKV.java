...
/**
 * Renderiza un Sprite de King Valley. Solo se usa en tiempo de debug para
 * visualizar elementos invisibles, como comienzos y finales de escaleras, muros
 * trampa y activadores.
 * 
