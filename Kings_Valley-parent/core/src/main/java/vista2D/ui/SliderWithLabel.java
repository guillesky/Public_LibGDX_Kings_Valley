...
public class SliderWithLabel extends Table
{
	...
	this.add(labelTitle).width( width*(350f/1920f)).left().padRight(10);
	this.add(slider).growX().minWidth(width*(350f/1920f)).padRight(10);
	this.add(labelValue).width(width*(40f/1920f)).right();
