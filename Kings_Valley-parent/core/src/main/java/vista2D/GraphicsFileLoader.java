...
public class GraphicsFileLoader
{
	...
	private void loadPlayerAnimations()
	{
		...
		int totalCount = 25;/*countIddle + countFall + countWalk + pickerCountIddle + pickerCountFall + pickerCountWalk
				+ pickerCountPicking + daggerCountIddle + daggerCountFall + daggerCountWalk + daggerCountThrowing
				+ countDeath;*/
