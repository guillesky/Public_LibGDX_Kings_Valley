...
public class TileMapGrafica2D implements IMyApplicationnListener
{
    ...
    /*
     * private AnimatedPickedCell animatedPickedCell; private
     * Animation<TextureRegion>[] animationPlayer_Nothing = new Animation[6];
     ...
     * private HashMap<Integer, Animation<TextureRegion>> animations = new
     * HashMap<Integer, Animation<TextureRegion>>();
     * 
     */
...

	{
		...
		this.animatedEntities.add(new GameCharacterAnimated2D(mummy, animation));
	    }
	}
