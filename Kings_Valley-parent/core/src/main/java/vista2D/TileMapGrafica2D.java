...
public class TileMapGrafica2D implements IMyApplicationnListener
{
	...
	private final String archiMummyBlue = "pics/mummy_blue.png";
	private final String archiMummyOrange = "pics/mummy_orange.png";
	private final String archiMummyRed = "pics/mummy_red.png";
	private final String archiMummyWhite = "pics/mummy_white.png";
	private final String archiMummyYellow = "pics/mummy_yellow.png";
	private final String archiMummyAppear = "pics/mummy_appear.png";
	private final String archiMummyDisappear = "pics/mummy_disappear.png";
	...
	private Animation<TextureRegion>[] animationMummyBlue = new Animation[3];
	private Animation<TextureRegion>[] animationMummyOrange = new Animation[3];
	private Animation<TextureRegion>[] animationMummyRed = new Animation[3];
	private Animation<TextureRegion>[] animationMummyWhite = new Animation[3];
	private Animation<TextureRegion>[] animationMummyYellow = new Animation[3];
	...
	public TileMapGrafica2D(AssetManager manager)
	{
		...
		this.manager.load(this.archiMummyBlue, Texture.class);
		this.manager.load(this.archiMummyOrange, Texture.class);
		this.manager.load(this.archiMummyRed, Texture.class);
		this.manager.load(this.archiMummyWhite, Texture.class);
		this.manager.load(this.archiMummyYellow, Texture.class);
	...
	private void loadAnimations()
	{
		...
		this.loadPlayerAnimations(frameWidth, frameHeight, frameDuration);
		this.loadColectablesAnimations(frameDuration);
		this.loadMummyAnimations(archiMummyBlue,this.animationMummyBlue,frameWidth, frameHeight, frameDuration);
		this.loadMummyAnimations(archiMummyOrange,this.animationMummyOrange,frameWidth, frameHeight, frameDuration);
		this.loadMummyAnimations(archiMummyRed,this.animationMummyRed,frameWidth, frameHeight, frameDuration);
		this.loadMummyAnimations(archiMummyWhite,this.animationMummyWhite,frameWidth, frameHeight, frameDuration);
		this.loadMummyAnimations(archiMummyYellow,this.animationMummyYellow,frameWidth, frameHeight, frameDuration);
		
	}

	private void loadMummyAnimations(String archiMummy, Animation<TextureRegion>[] animationMummy,
			int frameWidth, int frameHeight, float frameDuration)
	{
		...
		animationMummy[IDDLE] = this.framesToAnimation(linearFrames, startIddle, countIddle, 0);
		animationMummy[FALL] = this.framesToAnimation(linearFrames, startFall, countFall, 0);
		animationMummy[WALK] = this.framesToAnimation(linearFrames, startWalk, countWalk, frameDuration);
	...
	private void loadColectablesAnimations(float frameDuration)
	{
		...
		TextureRegion[][] tmpFrames = TextureRegion.split(colectablesSheet, colectableWidth, colectableHeight);
		Array<TextureRegion> linearFrames = new Array<>();
		for (int i = 0; i < tmpFrames.length; i++)
		{
			for (int j = 0; j < tmpFrames[i].length; j++)
		...
		this.animatedPickedCell = new AnimatedPickedCell(new LevelItem(0, 0, 0, 0, tileWidth, tileHeight),
				picking_cell);
	...
	private void loadPlayerAnimations(int frameWidth, int frameHeight, float frameDuration)
	{
		...
		this.animationPlayer_Nothing[FALL] = this.framesToAnimation(linearFrames, startFall, countFall, 0);
		this.animationPlayer_Nothing[JUMP] = this.animationPlayer_Nothing[FALL];
		...
		this.animationPlayer_Picker[FALL] = this.framesToAnimation(linearFrames, startFall + 6, countIddle, 0);
		...
		this.animationPlayer_Dagger[FALL] = this.framesToAnimation(linearFrames, startFall + 12, countIddle, 0);
