...
public class TileMapGrafica2D implements IMyApplicationnListener
{
    ...
    private ArrayList<AnimatedDoor2D> animatedDoor2D = new ArrayList<AnimatedDoor2D>();
	...
	this.animatedDoor2D = new ArrayList<AnimatedDoor2D>();
	...
	Iterator<AnimatedDoor2D> itDoors = this.animatedDoor2D.iterator();
	while (itDoors.hasNext())
	{
	    AnimatedDoor2D animatedDoor = itDoors.next();
