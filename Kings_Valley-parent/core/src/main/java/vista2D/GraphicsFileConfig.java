...
/**
 * @author Guillermo Lazzurri Clase que representa la configuracion de los
 *         elementos graficos para una representacion en 2D
 */
public class GraphicsFileConfig
{
	...
	/**
	 * @return cantidad de frames de la animacion iddle del player cuando porta un pico
	 */
	...
	/**
	 * @return cantidad de frames de la animacion de caida del player cuando porta un pico
	 */
	...
	/**
	 * @return cantidad de frames de la animacion de caminata del player cuando porta un pico
	 */
	...
	/**
	 * @return cantidad de frames de la animacion iddle del player cuando porta una espada
	 */
	...
	/**
	 * @return cantidad de frames de la animacion de caida del player cuando porta una espada
	 */
	...
	/**
	 * @return cantidad de frames de la animacion de caminata del player cuando porta una espada
	 */
	...
	/**
	 * @return Archivo con las texturas de las animaciones especiales del player (picando y lanzando espadas)
	 */
