...
public abstract class Mummy extends GameCharacter
{
	...
	public static final int ST_WAITING = 100;
	public static final int ST_LIMBUS = 101;

	public static final int ST_APPEARING = 102;
	public static final int ST_DISAPPEARING = 103;
	...
	protected float distanceQuadToPlayer()
	{
		float deltaX = this.getX() - this.pyramid.getPlayer().getX();
		float deltaY = this.getY() - this.pyramid.getPlayer().getY();
