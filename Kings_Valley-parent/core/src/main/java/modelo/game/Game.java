...
public class Game implements KVEventListener
{
	...
	private KVEventListener audioListener;
	...
	public KVEventListener getAudioListener()
	{
		return audioListener;
	}

	public void setAudioListener(KVEventListener audioListener)
	{
	...
	public void eventFired(int eventCode, Object param)
	{
		...
		if (this.audioListener != null)
			this.audioListener.eventFired(eventCode, param);
	...
	{
		/*
		 * Player player = this.level.getPlayer(); this.lolo = new Lolo(player);
		 * 
