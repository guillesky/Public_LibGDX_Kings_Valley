...
public class LevelReader
{
    ...
    public Level getLevel(int id, TiledMap map, int dificultLevel, boolean isCompleted, 
	    IGrafica interfaz) 
    {
	return this.getLevel(id, map, dificultLevel, isCompleted, null, interfaz);
    }
    
    public Level getLevel(int id, TiledMap map, int dificultLevel, boolean isCompleted, Door doorFrom,
	    IGrafica interfaz)
    {
	...
	float y = door.getPassage().y+ Config.getInstance().getLevelTileHeightUnits()*.01f;
