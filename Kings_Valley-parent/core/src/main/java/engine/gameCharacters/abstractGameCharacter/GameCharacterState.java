...
public abstract class GameCharacterState
{
	 ...
	 * 
	 * @param v         Objecto de tipo Vector2 que representa la trayectoria
	 *                  pretendida.
	 * @param b         true si se pretende realizar una accion, false en caso
	 *                  contrario
	 ...
	 * 
	 * @param v         Objeto de tipo Vector2 que representa la trayectoria
	 *                  pretendida.
	 * @param b         Indica si se pretenda realizar una accion (puede ser saltar,
	 *                  arrojar espada o picar)
