...
public abstract class DaggerState
{
    ...
    /**
     * Retorna el codigo numerico del estado (no confundir con el patron state)<br>
     * Puede tomar los valores: <br>
     * ST_STUCKED;<br>
     * ST_THROWING_HORIZONTAL;<br>
     * ST_FALLING;<br>
     * ST_THROWING_UP;<br>
     * ST_BOUNCING;<br>
     * ST_PICKUPED<br>
     * 
     * @return codigo numerico del estado (no confundir con el patron state)<br>
     *         Puede tomar los valores: <br>
     *         ST_STUCKED;<br>
     *         ST_THROWING_HORIZONTAL;<br>
     *         ST_FALLING;<br>
