...
import keyboardGameControl.KeyboardGameControl;
...
public class Game implements KVEventListener
{
    ...
    /**
     * codigo para tipo de juego clasico
     */
    public static final int GAME_TYPE_CLASSIC = 0;
    /**
     * codigo para tipo de juego extendido
     */
    public static final int GAME_TYPE_EXTENDED = 1;
    /**
     * codigo para tipo de juego Gran Templo
     */
     ...
     *                      valor normal. Si el valor es mayor 4 se tomara el valor
     *                      4. Si es menor a -4 se tomara el valor -4
     */
    public void startNewClassicGame(int dificultLevel)
    {
	this.gameType = Game.GAME_TYPE_CLASSIC;
	this.dificultLevel = dificultLevel;
     ...
     *                      valor normal. Si el valor es mayor 4 se tomara el valor
     *                      4. Si es menor a -4 se tomara el valor -4
     * @param initialTemple Indica el numero de templo en el cual hay que iniciar el
     *                      juego
     */
    public void startNewGreatTempleGame(int dificultLevel, int initialTemple)
    {
	this.gameType = Game.GAME_TYPE_GREAT_TEMPLE;
	this.dificultLevel = dificultLevel;
     ...
     *                       valor normal. Si el valor es mayor 4 se tomara el valor
     *                       4. Si es menor a -4 se tomara el valor -4
     * @param initialEpisode Indica el episodio desde el que se debe iniciar el
     *                       juego.
     */

    public void startNewExtendedGame(int dificultLevel, int initialEpisode)
    {
	this.gameType = Game.GAME_TYPE_EXTENDED;
	this.dificultLevel = dificultLevel;
    ...
    /**
     * Retorna el tipo de juego, puede tomar los valores:<br>
     * Game.GAME_TYPE_CLASSIC = 0;<br>
     * Game.GAME_TYPE_EXTENDED = 1;<br>
     * Game.GAME_TYPE_GREAT_TEMPLE = 2;<br>
     * 
     * @return El tipo de juego, puede tomar los valores:<br>
     *         Game.GAME_TYPE_CLASSIC = 0;<br>
     *         Game.GAME_TYPE_EXTENDED = 1;<br>
     *         Game.GAME_TYPE_GREAT_TEMPLE = 2;<br>
     */
