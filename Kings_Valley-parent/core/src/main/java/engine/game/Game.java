...
public class Game implements KVEventListener
{
	 ...
	 *                      valor normal. Si el valor es mayor 4 se tomara el valor
	 *                      4. Si es menor a -4 se tomara el valor -4
	 * @param initialTemple Indica el numero de templo en el cual hay que iniciar el juego
	 */
	 ...
	 *                      valor normal. Si el valor es mayor 4 se tomara el valor
	 *                      4. Si es menor a -4 se tomara el valor -4
	 * @param initialEpisode Indica el episodio desde el que se debe iniciar el juego.
	 */
