...
/**
 * Clase que contiene valores constantes usados internamente por el juego. No
 * debe instanviarse un objeto de este tipo
 * 
...
public class Constants
{
	 ...
	 */
	public static final String VERSION = "v 1.2.1 r 2026-06-04";
	...
	private static void inicializeLevelsFile(HashMap<Integer, String> levelFileName, String prefix, int lastLevel)
	{
		for (int i = 1; i <= lastLevel; i++)
		{
			if (i < 10)
			{
				levelFileName.put(i, prefix + "0" + i + ".tmx");
			} else
			{
				levelFileName.put(i, prefix + i + ".tmx");
			}
		}

		levelFileName.put(lastLevel + 1, "maps/goal.tmx");

	}

	/**
	 * Constructor de clase privado, no deberia instanciarse ningun objeto de este
	 * tipo.
	 */
	private Constants()
	{
